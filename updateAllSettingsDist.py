...
ip = raw_input("Please enter the IP address of the login server machine: ")
f.write("\nip_address="+str(ip))
...
shutil.copy("login.conf", "dist/aws/")
shutil.copy("login.conf", "dist/aws_server/")
shutil.copy("login.conf", "dist/aws_login_server/")
