...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Armoured Warfare", pos = wx.DefaultPosition, size = wx.Size( 400,350 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class TankBuy ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Purchase a tank", pos = wx.DefaultPosition, size = wx.Size( 300,200 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.priceBox = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 160,-1 ), wx.TE_READONLY )
...
class UpgradeForm ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Upgrade A Tank", pos = wx.DefaultPosition, size = wx.Size( 400,420 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
