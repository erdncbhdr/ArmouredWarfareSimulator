...
class MainFrame(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Super Secure Login", pos=wx.DefaultPosition,
                           size=wx.Size(300, 190), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.passBox = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(130, -1),
...
class newAccount(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Create a new account", pos=wx.DefaultPosition,
                          size=wx.Size(350, 170), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)

        bSizer1 = wx.BoxSizer(wx.VERTICAL)

        self.inst = wx.StaticText(self, wx.ID_ANY, u"Please enter your details to create a new account.",
