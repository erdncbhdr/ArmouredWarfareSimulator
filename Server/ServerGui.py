...
class Mainframe(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Armoured Warfare Server", pos=wx.DefaultPosition,
        ...
        self.interfaceChoice = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(150, -1), interfaceChoiceChoices,
                                         0)
        ...
        self.statusLab = wx.StaticText(self, wx.ID_ANY, u"Server is not running.", wx.DefaultPosition, wx.DefaultSize,
                                       0)
...
class FillerFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(200, 100), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)

        bSizer2 = wx.BoxSizer(wx.VERTICAL)

        self.qwqq = wx.StaticText(self, wx.ID_ANY, u"There is a game in progress", wx.DefaultPosition, wx.DefaultSize,
                                  0)
        self.qwqq.Wrap(-1)
